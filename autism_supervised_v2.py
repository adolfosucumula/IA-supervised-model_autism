...
db = DB().getDatabase("/Users/Feti/Documents/ONLINE COURSES/test-codes/IA-supervised-model_autism/Autism_screening dataset.arff");
...
print('')
print(df.describe())
print("____________________DATASETS CORRELATION EXCLUDIN 'na/null'__________________")
print('')
print(df.corr())
print('')
...
#Selecting the dependent column or variable 
target = df.hasAUTISM
#Selecting the independent columns or variables 
